...
void draw(){
  if(game == 0){
    ...
    image(hole1Img, 200, 200, 200, 200);
    image(hitmouseImg, 200, 230, 200, 200);
    image(hithammerImg, 280, 210, 100, 100);
    image(hole2Img, 200, 200, 200, 200);
  }
  if(game == 1){
    background(207, 161, 109);
    fill(255);
    ...
    image(hole1Img, 120, 120, 150, 150);
    image(mouseImg, 120, 150, 150, 150);
    image(hole2Img, 120, 120, 150, 150);
    image(hole1Img, 120, 270, 150, 150);
    image(badmouseImg, 120, 300, 150, 150);
    image(hole2Img, 120, 270, 150, 150);
  }
  if(game == 2){
    background(207, 161, 109);
